...
class termine_aowa extends admController{
	private $ensembles; 
public function __construct(){
parent::__construct();
	$this->ensembles = array("Konzertorchester", "Accento","Akkordissimo","Ton-Akrobaten");
...
public function form($prop,$action,$vars,$usform){
	$selectArray=self::select("SELECT * FROM zb_ensembles ORDER BY ensembel_id ASC");
	//print_r($selectArray);
