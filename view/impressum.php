...
echo $o->publicEditIcon($arr[0]["id"]."-zb_impressum-impressuma");
echo "<h2>".$arr[0]["ueberschrift"]."</h2>";
if(count($array)>0){$o->mainCaroussel($_REQUEST["controller"],$array); 
}
...
echo "</div>";
 ...
 if(count($arr)>1){
	do{
	echo "<div class=\"container mb-4 mt-4\">";
	echo $o->publicEditIcon($arr[$i]["id"]."-zb_impressum-impressuma");
